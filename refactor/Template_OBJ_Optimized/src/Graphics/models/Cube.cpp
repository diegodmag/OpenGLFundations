...
void Cube::translate(const linear::math::Vector3D& translation){
    m_model_mat = linear::math::Matrix4D::translate(translation) * m_model_mat;
}

void Cube::rotate(float angle, const linear::math::Vector3D& axis){
...
void Cube::scale(const linear::math::Vector3D& scaling){
    m_model_mat = linear::math::Matrix4D::scale(scaling) * m_model_mat;
}

void Cube::renderModel(const linear::math::Matrix4D& view, const linear::math::Matrix4D& projection){
